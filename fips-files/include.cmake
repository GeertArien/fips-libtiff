...
set(tiff_VERSION "${tiff_VERSION_MAJOR}.${tiff_VERSION_MINOR}.${tiff_VERSION_PATCH}")
...
# JPEG
option(TIFF_JPEG "use libjpeg (required for JPEG compression)" OFF)
...
message(STATUS "")
message(STATUS "  Version:                            ${tiff_VERSION}")
message(STATUS "")
...
message(STATUS "  ZLIB support:                       ${TIFF_ZLIB} (requested) ${ZLIB_SUPPORT} (availability)")
message(STATUS "  Pixar log-format algorithm:         ${TIFF_PIXARLOG} (requested) ${PIXARLOG_SUPPORT} (availability)")
message(STATUS "  JPEG support:                       ${TIFF_JPEG} (requested) ${JPEG_SUPPORT} (availability)")
message(STATUS "  Old JPEG support:                   ${TIFF_OLD_JPEG} (requested) ${OJPEG_SUPPORT} (availability)")
